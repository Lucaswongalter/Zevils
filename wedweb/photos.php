...
<? fancyImage("waffle.jpg", "Matthew eagerly anticipates digging into his 'Multigrain Delight.'", 150, 200); ?>
<? fancyImage("bento.jpg", "Liz displays a bento boxed lunch, complete with monkey containers to hold dressing.", 150, 200); ?>
<? fancyImage("mattSAzoo.jpg", "Matthew communes with the lorikeets at the San Antonio Zoo.", 150, 200); ?>
<? fancyImage("mattMacs.jpg", "Matthew with the 'Mac' apples on a New England apple-picking excursion.", 150, 200); ?>
<? fancyImage("appleButter.jpg", "Liz pulls a batch of apple butter out of the canner.", 150, 200); ?>
...
<p>
<? /* fancyImage("filename.jpg", "The Caption Goes Here", thumbnail-width, thumbnail-height); */ ?>
<? fancyImage("tabitree.jpg", "Tabi looks down from her tower.", 200, 150); ?>
<? fancyImage("tabibed.jpg", "Tabi with one of her (many) toys.", 200, 150); ?>
<? fancyImage("tabifloor.jpg", "Tabi finds a sunspot.", 200, 150); ?>
</p></dd>
...
<p>
<? /* fancyImage("filename.jpg", "The Caption Goes Here", thumbnail-width, thumbnail-height); */ ?>
<? fancyImage("lizgraduation.jpg", "Liz's undergrad commencement (2006): Dave (dad), Alexander (brother), Liz, Jean (mom), Isaac (brother), Marilynne (grandmother), Paul (grandfather).", 200, 150); ?>
...
<? fancyImage("GiffordsEarly1.jpg", "Dressed up for Easter church.", 200, 150); ?>
</p></dd>
